...
1. The **most common case**, is that the user needs to [manually install the server](/page/installation), and then [configure their language-client](/page/client-configuration) to start the server for `*.fish` files.
...
- The project is **open-source** and contributions are welcome! If you would like to contribute, please see the [Contributing Guide](/page/contributing).
